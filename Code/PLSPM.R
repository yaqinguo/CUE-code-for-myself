...
LVs <- c("topography","climate","season","soil","vegetation","CUE")

path_matrix <- matrix(0,nrow = 6, ncol = 6, dimnames = list(LVs, LVs))

path_matrix["topography", c("climate","season","soil")] <- 1
path_matrix["climate", c("season","vegetation")] <- 1
path_matrix["season", c("soil","vegetation")] <- 1
# path_matrix["clay", c("soil")] <- 1
path_matrix["soil", c("vegetation", "CUE")] <- 1
path_matrix["vegetation","CUE"] <- 1
