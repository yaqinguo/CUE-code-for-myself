...
LVs <- c("topography","climate","season","texture","soil","vegetation","CUE")

path_matrix <- matrix(0,nrow = 7, ncol = 7, dimnames = list(LVs, LVs))
...
path_matrix["soil",c("vegetation","CUE")] <- 1
path_matrix["vegetation", c("CUE")] <- 1
...
top_effect$Predictor <- factor(top_effect$Predictor, levels = c("topography","climate","season","texture","soil","vegetation"),
                               labels = c("Topography","Climatic factors","Climatic seasonality","Soil texture","Soil properties","Vegetation"))
...
sub_effect$Predictor <- factor(sub_effect$Predictor, levels = c("topography","climate","season","texture","soil","vegetation"),
                               labels = c("Topography","Climatic factors","Climatic seasonality","Soil texture","Soil properties","Vegetation"))
